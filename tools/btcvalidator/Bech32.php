 ...
 * @throws Bech32Exception
 */
function decodeSegwit($hrp, $bech32): array
{
    [$hrpGot, $data] = decode($bech32);
 ...
 * @return string
 */
function encode($hrp, array $combinedDataChars): string
{
 ...
 * @return int[]
 */
function createChecksum($hrp, array $convertedDataChars): array
{
 ...
 * @return array Returns [$hrp, $dataChars]
 */
function decodeRaw($sBech): array
{
    $length = strlen($sBech);
 ...
 * @return bool
 */
function verifyChecksum($hrp, array $convertedDataChars): bool
{
 ...
 * @return int[]
 */
function hrpExpand($hrp, $hrpLen): array
{
    $expand1 = [];
    $expand2 = [];
 ...
 * @return int
 */
function polyMod(array $values, $numValues): int
{
    $chk = 1;
 ...
 * @throws Bech32Exception
 */
function convertBits(array $data, $inLen, $fromBits, $toBits, $pad = true): array
{
    $acc = 0;
    $bits = 0;
    $ret = [];
 ...
 * @throws Bech32Exception
 */
function validateWitnessProgram($version, $program): void
{
